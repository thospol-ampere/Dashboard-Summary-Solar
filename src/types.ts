...
export const PROVINCE_MAP: Record<string, { region: LocationItem['region']; x: number; y: number }> = {
  'กรุงเทพมหานคร': { region: 'กรุงเทพมหานคร', x: 45, y: 58 },
  'นนทบุรี': { region: 'กรุงเทพมหานคร', x: 44, y: 57 },
  'ปทุมธานี': { region: 'กรุงเทพมหานคร', x: 45, y: 56 },
  'สมุทรปราการ': { region: 'กรุงเทพมหานคร', x: 46, y: 59 },
  ...
  'นครปฐม': { region: 'ภาคกลาง', x: 40, y: 57 },
  'สุพรรณบุรี': { region: 'ภาคกลาง', x: 40, y: 51 },
  'สมุทรสาคร': { region: 'ภาคกลาง', x: 42, y: 59 },
  'สมุทรสงคราม': { region: 'ภาคกลาง', x: 39, y: 60 },
  ...
  'ราชบุรี': { region: 'ภาคตะวันตก', x: 35, y: 59 },
  'เพชรบุรี': { region: 'ภาคตะวันตก', x: 36, y: 65 },
  'ประจวบคีรีขันธ์': { region: 'ภาคตะวันตก', x: 35, y: 72 },
